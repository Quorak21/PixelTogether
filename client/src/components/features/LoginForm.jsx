...
function LoginForm({ }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = fetch('http://localhost:3000/api/test-db', {
                method: 'POST',
    ...
    return (
        isLoginOpen ? (
            ...
            >
                ...
                <div ref={nodeRef} className="bg-white p-8 rounded-2xl shadow-2xl w-96 relative">
                    ...
                    {/* 2. Le Titre */}
                    <h2 className="drag-handle cursor-movetext-2xl font-bold mb-6 text-center text-gray-800">
