...
### 1. Gestion de l'état UI ([ui-state.service.ts](./src/app/core/services/ui-state.service.ts))
...
### 2. Gestion de la reconnexion ([reconnect.service.ts](./src/app/core/services/reconnect.service.ts))
...
### 3. Jeton de Session ([session-token.service.ts](./src/app/core/services/session-token.service.ts))
...
### 4. Communication Socket ([socket.service.ts](./src/app/core/services/socket.service.ts))
...
### 1. Le Canvas Interactif ([canvas.ts](./src/app/features/game/canvas/canvas.ts))
...
### 2. Palette de Couleurs ([color-palette.ts](./src/app/features/game/color-palette/color-palette.ts))
...
### 3. Boîte de discussion ([chatbox.ts](./src/app/shared/chatbox/chatbox.ts))
